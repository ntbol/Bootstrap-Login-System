...
<body style="background-image: -webkit-linear-gradient(#0F2027, #203A43, #2C5364);">
    ...
    <div class="center-div">
        <div class="float" align="center">
            <i class="fa fa-user fa-3x" style="color:#203A43"></i>
            <h1 class="title" style="padding-bottom: 15px;">Register</h1>
            ...
            <p class="tiny">Already have an account? <span class="themelink"><a href="index.php">Login here</a></span>.</p>
        </form>
        </div>
    </div>
